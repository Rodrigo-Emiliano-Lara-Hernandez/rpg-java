package rpg.entities.enemies.DragonHielo;
...
public class DragonHielo extends Enemy {
    ...
    /**
     * Agregar constructor para DragonHielo
     */

    public DragonHielo() {
            super("Dragon de Hielo");
            ImageCache.addImage("DragonHielo", "Enemies/DragonHielo.png");
        }
    ...
    @Override
    public void getLoot() {
        System.out.println("The Dragon Hielo drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            El Dragon de Hielo realiza aliento helado y te hace 2 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            El Dragon de Hielo te congela y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("DragonHielo");
    }
    }
