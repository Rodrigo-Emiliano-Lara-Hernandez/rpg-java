package rpg.entities.enemies.QuimeraMutante;
...
public class QuimeraMutante extends Enemy {
    ...
    /**
     * Agregar constructor para QuimeraMutante
     */

    public QuimeraMutante() {

        super("Quimera Mutante");
        ImageCache.addImage("QuimeraMutante", "Enemies/QuimeraMutante.png");
    }
    ...
    @Override
    public void getLoot() {
        System.out.println("The Quimera Mutante drops a small bag of coins.");
    }
        ...
        switch (attack) {
            case 1:
                try {
                    ...
                    message = """
                            La Quimera Mutante te rasguña y te hace 2 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
            case 2:
                try {
                    ...
                    enemy.getStats().put(Stats.HP, 0);
                    message = """
                            La Quimera Mutante muerde salvajemente y te hace 3 de daño.
                            ¡Has muerto!
                            """;
                }
                break;
    ...
    public ImageIcon getSprite() {
        ...
        return ImageCache.getImageIcon("QuimeraMutante");
    }
}